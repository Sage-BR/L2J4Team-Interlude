 ...
 *
 */
public class Skin24 implements IItemHandler

{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
    {
        if(Config.ALLOW_DRESS_ME_SYSTEM)
        {
            ...
            RequestBypassToServer.setPart(activeChar, "weap", Config.SKIN_NAME24);
			...
			else
			{
				...
				activeChar.broadcastUserInfo();
				activeChar.sendMessage("You have activated " + Config.NAME24 + " skin.");
