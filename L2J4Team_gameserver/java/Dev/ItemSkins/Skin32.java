 ...
 *
 */
public class Skin32 implements IItemHandler

{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
    {
        if(Config.ALLOW_DRESS_ME_SYSTEM)
        {
            ...
            RequestBypassToServer.setPart(activeChar, "weap", Config.SKIN_NAME32);
			...
			else
			{
				...
				activeChar.broadcastUserInfo();
				activeChar.sendMessage("You have activated " + Config.NAME32 + " skin.");
