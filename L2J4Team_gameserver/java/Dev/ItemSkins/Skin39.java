 ...
 *
 */
public class Skin39 implements IItemHandler

{
	...
	public void useItem(Playable playable, ItemInstance item, boolean forceUse)
    {
        if(Config.ALLOW_DRESS_ME_SYSTEM)
        {
            ...
            RequestBypassToServer.setPart(activeChar, "weap", Config.SKIN_NAME39);
			...
			else
			{
				...
				activeChar.broadcastUserInfo();
				activeChar.sendMessage("You have activated " + Config.NAME39 + " skin.");
